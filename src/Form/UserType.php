    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add("username", TextType::class, [
                ...
                "required" => true,
                "constraints" => [
                    new Length(["min"=> 3, "max"=> 180, "minMessage" => "Le nom d'utilisateur ne peut pas faire moins de 3 caractères", "maxMessage" => "Le nom d'utilisateur ne doit pas faire plus de 180 caractères"]),
            ...
            ->add("confirm", PasswordType::class, [
                ...
                "constraints" => [
                    new NotBlank(["message" => "Le mot de passe ne doit pas être  vide !"]),
                    // new EqualTo(["propertyPath" => "password", "message" => "Les mots de passe doivent être identiques !"])
